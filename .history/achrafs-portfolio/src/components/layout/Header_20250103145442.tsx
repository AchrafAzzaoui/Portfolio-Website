    ...
    <header className="px-2 py-4">
      <nav className="flex ">
        ...
        <div className="basis-6/16 flex-auto flex justify-evenly items-center">
          ...
          <button
            className="relative inline-block px-5 py-2 font-semibold rounded-md 
                   border-2 border-purple-500 bg-transparent text-white 
                   overflow-hidden group 
                   before:absolute before:inset-0 before:-translate-x-full 
                   before:bg-gradient-to-r before:from-purple-600 
                   before:to-purple-800 before:z-0 before:rounded-md
