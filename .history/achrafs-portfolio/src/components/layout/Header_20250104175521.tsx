  ...
  return (
    <>
      <header className=" fixed top-0 left-0 right-0 z-50 backdrop-blur-sm  shadow-[0_4px_10px_rgba(0,0,0,0.3)] border-b transition-shadow duration-300 border-white/10 px-2 xl:px-10 py-5">
        <nav className="flex ">
          <div className="basis-3/16 flex-auto flex justify-start pl-2 md:pl-0 md:justify-center items-center font-display font-bold text-dark-text-primary">
            <a href="#home">
        ...
        {isMenuOpen && (
          ...
          >
            <a
              ...
              className="w-full py-2 text-center font-sans font-medium text-dark-text-primary text-lmd"
            >
              About
            </a>
            <a
            ...
            <button
              ...
              className="
    mt-5 inline-block px-7 py-2 font-semibold font-display bg-transparent text-white group
    hover:border-purple-500
    before:absolute before:content-[''] before:inset-0
    before:-translate-x-full before:bg-gradient-to-r before:from-purple-600
    before:to-purple-800 before:z-0
