  ...
  return (
    <header className="px-2 py-4 border-8 border-red-500">
      <nav className="flex px-2 py-2">
        <div className="basis-3/16 flex-auto flex justify-start items-center font-display font-bold text-dark-text-primary">
          <h2 className="text-xl px-4">Achraf Azzaoui</h2>
        </div>
        ...
        <div className="basis-6/16 flex-auto flex justify-end items-center">
