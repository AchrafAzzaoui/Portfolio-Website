        ...
        {isMenuOpen && (
          ...
          >
            <a
              ...
              className="w-full py-3 text-center font-sans font-medium text-dark-text-primary text-lmd"
            >
              About
            </a>
            <a
              href="#skills"
              onClick={() => setIsMenuOpen(false)}
              className="w-full py-3 text-center font-sans font-medium text-dark-text-primary text-md"
            >
              Skills
            </a>
            <a
