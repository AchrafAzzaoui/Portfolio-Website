  ...
  return (
    <header className="px-2 py-4 border-8 border-red-500">
      <nav className="flex ">
        ...
        <div className="basis-1/4 flex-auto flex justify-evenly items-center ">
          ...
          <button className="px-10 py-2.5 border-2 border-dark-text-primary rounded-md text-dark-text-primary font-sans font-medium">
            Contact
          </button>
        </div>
      </nav>
