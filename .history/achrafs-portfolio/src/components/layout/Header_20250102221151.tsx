...
export default function Header() {
  ...
  return (
    <header className="px-2 py-4 border-8 border-red-500">
      <nav className="flex ">
        <div className="basis-1.5/7 flex-auto flex justify-center items-center font-display font-bold text-dark-text-primary border-4 border-red-500">
          <h2 className="text-xl">Achraf Azzaoui</h2>
        </div>
        <div className="basis-3/7 flex-auto flex justify-evenly items-center border-4 border-red-500">
          <a
            href="#home"
        ...
        <div className="basis-2/7 flex-auto flex justify-evenly items-center border-4 border-red-500">
